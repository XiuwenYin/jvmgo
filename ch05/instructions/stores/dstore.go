...
func (self *DSTORE_0) Execure(frame *rtda.Frame) {
	_dstore(frame, 0)
}

func (self *DSTORE_1) Execure(frame *rtda.Frame) {
	_dstore(frame, 1)
}

func (self *DSTORE_2) Execure(frame *rtda.Frame) {
	_dstore(frame, 2)
}

func (self *DSTORE_3) Execure(frame *rtda.Frame) {
	_dstore(frame, 3)
}
